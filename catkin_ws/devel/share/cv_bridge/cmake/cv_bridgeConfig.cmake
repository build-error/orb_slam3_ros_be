...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/build-error-ubuntu/orb_slam3_ros_be/catkin_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/build-error-ubuntu/orb_slam3_ros_be/catkin_ws/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/build-error-ubuntu/orb_slam3_ros_be/catkin_ws/install)
...
if(NOT "/home/build-error-ubuntu/orb_slam3_ros_be/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/build-error-ubuntu/orb_slam3_ros_be/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/build-error-ubuntu/orb_slam3_ros_be/catkin_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/local/lib/libopencv_core.so.4.9.0;/usr/local/lib/libopencv_imgproc.so.4.9.0;/usr/local/lib/libopencv_imgcodecs.so.4.9.0")
